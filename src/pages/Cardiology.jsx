      ...
      <section className="section-padding">
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1.5rem', gridAutoRows: 'minmax(200px, auto)' }}>
            ...
            {/* Smaller Bento Boxes */}
            <div className="glass-effect" data-aos="fade-up" style={{ padding: '2.5rem', borderRadius: 'var(--radius-xl)', background: 'linear-gradient(135deg, var(--surface-color) 0%, #fee2e2 100%)', borderLeft: '4px solid #ef4444' }}>
