        ...
        <div className="container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem', maxWidth: '1000px', margin: '0 auto' }}>
            {treatments.map((treatment, idx) => (
              <div key={idx} className="glass-effect" style={{ padding: '3rem 2rem', borderRadius: 'var(--radius-xl)', textAlign: 'center', transition: 'transform 0.3s, box-shadow 0.3s', cursor: 'pointer', borderTop: '4px solid #0284c7' }}
