      ...
      <section className="section-padding">
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1.5rem', gridAutoRows: 'minmax(200px, auto)' }}>
            ...
            <div className="glass-effect" data-aos="fade-up" style={{ gridColumn: '1 / -1', padding: '3rem', borderRadius: 'var(--radius-xl)' }}>
            ...
            {/* Smaller Bento Boxes */}
            <div className="glass-effect" data-aos="fade-up" style={{ padding: '2.5rem', borderRadius: 'var(--radius-xl)', background: 'linear-gradient(135deg, var(--surface-color) 0%, #f3e8ff 100%)', borderLeft: '4px solid #a855f7' }}>
